...
const ProfileConfig = {
    ...
    achievements: [
        ...
        { id: 'forensic_expert', name: 'Эксперт криминалистики', icon: '🔬', description: 'Анализ улик на высшем уровне' },
        { id: 'interrogator', name: 'Мастер допросов', icon: '🕵️', description: 'Раскусил всех лжецов' },
        { id: 'profiler', name: 'Профайлер', icon: '🧩', description: 'Составил психологический портрет' },

        // Серийные достижения
        { id: 'streak_5', name: 'Серия 5', icon: '🔥', description: '5 правильных ответов подряд' },
        { id: 'streak_10', name: 'Серия 10', icon: '💥', description: '10 правильных ответов подряд' },
        { id: 'streak_25', name: 'Непобедимый', icon: '⚡', description: '25 правильных ответов подряд' },
        { id: 'night_owl', name: 'Ночной охотник', icon: '🌙', description: 'Активность ночью (00:00-06:00)' },
        { id: 'early_bird', name: 'Ранняя пташка', icon: '🌅', description: 'Активность утром (06:00-10:00)' },

        // Социальные достижения
        { id: 'top_10', name: 'Топ-10', icon: '🥈', description: 'Попал в топ-10 рейтинга' },
        { id: 'top_3', name: 'Топ-3', icon: '🥇', description: 'Попал в топ-3 рейтинга' },
        { id: 'champion', name: 'Чемпион', icon: '👑', description: 'Занял первое место в рейтинге' },
        { id: 'consistent', name: 'Постоянство', icon: '📈', description: '7 дней игры подряд' },
        { id: 'dedicated', name: 'Преданный', icon: '💪', description: '30 дней игры подряд' },

        // Специализированные достижения
        { id: 'cold_case', name: 'Раскрыл холодное дело', icon: '❄️', description: 'Решил сложное дело' },
        { id: 'serial_killer', name: 'Поймал серийника', icon: '🔗', description: 'Остановил серийного убийцу' },
        { id: 'mob_boss', name: 'Босс мафии', icon: '🤵', description: 'Поймал главаря преступной группировки' },
        { id: 'cyber_crime', name: 'Киберпреступления', icon: '💻', description: 'Раскрыл дело о кибермошенничестве' },
        { id: 'drug_cartel', name: 'Наркокартель', icon: '💊', description: 'Разоблачил наркоторговцев' },

        // Технические достижения
        { id: 'fast_solver', name: 'Быстрое решение', icon: '⏱️', description: 'Решил дело за 30 секунд' },
        { id: 'marathon', name: 'Марафонец', icon: '🏃', description: '50 игр за один день' },
        { id: 'no_mistakes', name: 'Безошибочный', icon: '✅', description: '20 игр без единой ошибки' },
        { id: 'comeback', name: 'Возвращение', icon: '↩️', description: 'Вернулся после месяца перерыва' },
        { id: 'milestone_100', name: 'Сотня', icon: '💯', description: 'Провел 100 расследований' },

        // Редкие достижения
        { id: 'lucky_seven', name: 'Счастливая семерка', icon: '🍀', description: 'Угадал 7 сложных дел подряд' },
        { id: 'midnight_detective', name: 'Полуночный детектив', icon: '🕛', description: 'Играл в полночь 7 дней подряд' },
        { id: 'evidence_master', name: 'Мастер улик', icon: '🔍', description: 'Нашел все улики в 10 делах' },
        { id: 'interrogation_king', name: 'Король допросов', icon: '👨‍⚖️', description: 'Провел идеальные допросы' },
        { id: 'crime_scene_expert', name: 'Эксперт места преступления', icon: '🚧', description: 'Исследовал все улики на месте' }
    ]
};
...
class DramaticCriminalProfile {
    ...
    getAchievementRequirement(achievementId) {
        const requirements = {
            ...
            'forensic_expert': {
                text: 'Правильно определите улики в 15 делах',
                reward: '+250 очков опыта'
            },
            'interrogator': {
                text: 'Успешно раскройте ложь в 20 допросах',
                reward: '+300 очков опыта'
            },
            'profiler': {
                text: 'Точно опишите психологический тип в 10 делах',
                reward: '+350 очков опыта'
            },

            // Серийные достижения
            'streak_5': {
                text: 'Ответьте правильно на 5 вопросов подряд',
                reward: '+100 очков опыта'
            },
            'streak_10': {
                text: 'Ответьте правильно на 10 вопросов подряд',
                reward: '+200 очков опыта'
            },
            'streak_25': {
                text: 'Ответьте правильно на 25 вопросов подряд',
                reward: '+500 очков опыта'
            },
            'night_owl': {
                text: 'Играйте с 00:00 до 06:00 в течение недели',
                reward: '+150 очков опыта'
            },
            'early_bird': {
                text: 'Играйте с 06:00 до 10:00 в течение недели',
                reward: '+150 очков опыта'
            },

            // Социальные достижения
            'top_10': {
                text: 'Войдите в топ-10 рейтинга',
                reward: '+400 очков опыта'
            },
            'top_3': {
                text: 'Войдите в топ-3 рейтинга',
                reward: '+600 очков опыта'
            },
            'champion': {
                text: 'Займите первое место в рейтинге',
                reward: '+1000 очков опыта'
            },
            'consistent': {
                text: 'Играйте 7 дней подряд',
                reward: '+200 очков опыта'
            },
            'dedicated': {
                text: 'Играйте 30 дней подряд',
                reward: '+800 очков опыта'
            },

            // Специализированные достижения
            'cold_case': {
                text: 'Раскройте дело со сложностью 5 звезд',
                reward: '+300 очков опыта'
            },
            'serial_killer': {
                text: 'Поймайте серийного убийцу в специальном режиме',
                reward: '+400 очков опыта'
            },
            'mob_boss': {
                text: 'Разоблачите главаря мафии',
                reward: '+500 очков опыта'
            },
            'cyber_crime': {
                text: 'Раскройте дело о кибермошенничестве',
                reward: '+350 очков опыта'
            },
            'drug_cartel': {
                text: 'Поймайте наркоторговцев',
                reward: '+450 очков опыта'
            },

            // Технические достижения
            'fast_solver': {
                text: 'Решите дело менее чем за 30 секунд',
                reward: '+100 очков опыта'
            },
            'marathon': {
                text: 'Сыграйте 50 игр за один день',
                reward: '+600 очков опыта'
            },
            'no_mistakes': {
                text: 'Сыграйте 20 игр без единой ошибки',
                reward: '+400 очков опыта'
            },
            'comeback': {
                text: 'Вернитесь в игру после месяца перерыва',
                reward: '+250 очков опыта'
            },
            'milestone_100': {
                text: 'Проведите 100 расследований',
                reward: '+750 очков опыта'
            },

            // Редкие достижения
            'lucky_seven': {
                text: 'Угадайте 7 особо сложных дел подряд',
                reward: '+777 очков опыта'
            },
            'midnight_detective': {
                text: 'Играйте в полночь 7 дней подряд',
                reward: '+300 очков опыта'
            },
            'evidence_master': {
                text: 'Найдите все улики в 10 различных делах',
                reward: '+350 очков опыта'
            },
            'interrogation_king': {
                text: 'Проведите 25 идеальных допросов',
                reward: '+400 очков опыта'
            },
            'crime_scene_expert': {
                text: 'Исследуйте все места преступлений в деталях',
                reward: '+450 очков опыта'
            }
        };
